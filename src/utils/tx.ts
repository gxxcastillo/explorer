...
export const PROGRAM_DEPLOYMENTS = {
  ...
  [PROGRAM_NAMES.METAPLEX]: ALL_CLUSTERS,// MAINNET_ONLY,
  [PROGRAM_NAMES.RAYDIUM_AMM]: ALL_CLUSTERS, // MAINNET_ONLY,
  [PROGRAM_NAMES.RAYDIUM_IDO]: ALL_CLUSTERS, // MAINNET_ONLY,
  ...
  [PROGRAM_NAMES.SERUM_3]: ALL_CLUSTERS, // MAINNET_ONLY,
} as const;
...
export const PROGRAM_NAME_BY_ID = {
  ...
  metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s: PROGRAM_NAMES.METAPLEX,
